...
const EN: Record<string, string> = {
  ...
  'create.googleOptional': 'Optional Google Workspace',
  'create.quickSetup': 'Quick setup',
  'create.advancedSettings': 'Advanced settings',
  'create.googleNotice': 'After the agent is created, you will be prompted to log in with Google to activate these tools.',
  'create.agentCreated': 'Agent created successfully!',
  'create.agentReadyToLogin': 'Agent is ready — Google login needed to activate tools.',
  'create.googleLoginRequired': 'Google login required',
  'create.googleLoginNotice': 'You will be redirected to Google to grant access. After login, you will be returned to the dashboard.',
  'create.selectedToolsCount': '{count} Google tools selected:',
  'create.loginLater': 'Skip for now',
  'create.loginNow': 'Login with Google now',
